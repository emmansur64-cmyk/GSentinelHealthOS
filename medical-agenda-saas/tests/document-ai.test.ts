...
import { analyzeImageDocumentWithAI, isDocumentAIEnabled, isVisionSupportedMimeType } from "@/lib/document-ai";
...
function setDocumentAiEnv(overrides: Record<string, string | undefined> = {}) {
  ...
  process.env.DOCUMENT_AI_BASE_URL = "https://api.openai.com/v1";
  process.env.DOCUMENT_AI_MODEL = "gpt-4.1";
