"""NLU engine local (single source of truth para Brain).

Este módulo centraliza la detección de intención y extracción de entidades
sin depender de la carpeta MetaBrain.
"""
...
class NLUEngine:
    """Motor NLU local para intención + entidades."""
    ...
    def get_knowledge_metrics(cls) -> dict[str, Any]:
        ...
        return {
            ...
            "nlu_queries": cls._metrics["nlu_queries"],
        }
